...
Rectangle::Rectangle(Point a1, Point a2)
{
    point1=a1;
    point2=a2;
    while(a1.Get_X()<point2.Get_X())
    {
        a1.Move(1,0);
    }
    point3=a1;
    while(a2.Get_X()>point1.Get_X())
    {
        a2.Move(-1,0);
    }
    point4=a2;
    cout<<"For point 3 of rectangle:"<<endl;
    point3.Print(point3.Get_X(),point3.Get_Y());
    cout<<"For point 4 of rectangle:"<<endl;
    point4.Print(point4.Get_X(),point4.Get_Y());
    side1=point4.Get_Y()-point1.Get_Y();
    side2=point3.Get_X()-point1.Get_X();
}
// ********************************************************************
